    ...
    try {
      ...
      const tx = await program.methods
        .updatePoolInfo({
          ...
          demrMint: demrMint,
          : [new anchor.BN(1706625000), new anchor.BN(1706626200)],
          period2: [new anchor.BN(1706625000), new anchor.BN(1706626200)],
          reward1: [
          ...
          energyPerDay: [new anchor.BN("500"), new anchor.BN("500")],
          energyPerBox: new anchor.BN("1"),
          stakeStart: [new anchor.BN(1706627400), new anchor.BN(1706627400)],
